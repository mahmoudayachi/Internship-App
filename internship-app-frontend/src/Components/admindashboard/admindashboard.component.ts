...
export class AdmindashboardComponent {
   ...
   totalPages = 0;
   pageSize = 3;
   constructor(private adminservice :AdminserviceService, private form :FormBuilder , private router :Router ){
  ...
  ngOnInit(){
    ...
    this.adminservice.GetAllstudents().subscribe(res=>{
      this.list_of_students =res.content
